...
<div class="wrap clickwhale-pro-promo">
	<div class="clickwhale-pro-promo--hero">
		<div class="clickwhale-pro-promo--container">
			...
			<a href="" rel="noopener">Upgrade to ClickWhale (PRO) Now!</a>
			...
			<div class="clickwhale-pro-promo--why">
				<div class="clickwhale-pro-promo--why-grid">					
					<div class="clickwhale-pro-promo--why-item">
						...
						<p>Detailed statistics which allow you to filter and analyze link clicks and link page views.</p>
					</div>
					<div class="clickwhale-pro-promo--why-item">
						...
						<p>Easily place conversion tracking codes to track the performance of your WooCommerce or Easy Digital Downloads store.</p>
					</div>
					<div class="clickwhale-pro-promo--why-item">
						...
						<p>Add your social profiles to your existing link page in order to gain more followers on your favorite social networks.</p>
					</div>
					<div class="clickwhale-pro-promo--why-item">
	...
	<div class="clickwhale-pro-promo--subscribe" id="clickwhaleSubscribe">
		<div class="clickwhale-pro-promo--container">
			...
			<p><strong>Save 10%</strong> on your upgrade to ClickWhale (PRO) - Thank you for using our plugin already!</p>
