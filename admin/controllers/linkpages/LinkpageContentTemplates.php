	...
	public function get_template_row_images( array $data ) {
        ...
        <div class="linkpage-row--bottom--control-wrap linkpage-row--image-select--wrap">
            ...
            <div class="linkpage-row--image-select">
				...
				<?php
				$images = self::get_images();
				foreach ( $images as $tabKey => $tabArray ) {
					?>
                    <div class="linkpage-row--image-select--tab image-select--grid">
                        <div class="tab-inner">
							<?php foreach ( $tabArray as $imageID => $image ) { ?>
                                <div class="image-item">
                                    <input type="radio"
                                           data-type="<?php echo $tabKey ?>"
                                           id="image-<?php echo $data['id'] ?>-<?php echo $imageID ?>"
                                           name="links[<?php echo $data['id'] ?>][image][image_id]"
                                           value="<?php echo $imageID ?>"
										<?php
										if ( isset( $data['image']['image_id'] ) ) {
											checked( $data['image']['image_id'], $imageID );
										}
										?>
                                    >
                                    <label for="image-<?php echo $data['id'] ?>-<?php echo $imageID ?>">
										<?php if ( $tabKey === 'feather' ) { ?>
