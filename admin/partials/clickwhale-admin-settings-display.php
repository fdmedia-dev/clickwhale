...
<div class="wrap clickwhale-settings-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        <a href="?page=clickwhale-settings&tab=general_options" class="nav-tab <?php echo $active_tab == 'general_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'General Options', 'clickwhale' ); ?></a>
        <a href="?page=clickwhale-settings&tab=tracking_options" class="nav-tab <?php echo $active_tab == 'tracking_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Tracking Options', 'clickwhale' ); ?></a>
    </h2>
