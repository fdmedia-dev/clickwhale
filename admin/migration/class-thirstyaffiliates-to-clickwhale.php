...
class ThirstyAffiliates_To_ClickWhale extends ClickWhale_Migration_Notice{

    public static $pagenow;

    // Change this for new migration
    public static $migrant        = 'thirstyaffiliates';
    public static $migrant_full   = 'ThirstyAffiliates';
    public static $migrant_file   = 'thirstyaffiliates/thirstyaffiliates.php';
