	...
	public function add_plugin_menu() {
		...
		foreach ( $subpages as $k => $v ) {
			...
			add_submenu_page(
				...
				array( $this, 'render_' . $v['callback'] . '_page_view' )
			);
		}
