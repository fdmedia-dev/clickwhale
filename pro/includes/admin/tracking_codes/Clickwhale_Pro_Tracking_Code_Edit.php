...
class Clickwhale_Pro_Tracking_Code_Edit {
	...
	private static function default_dynamic_values_text(): string {
		...
		$text .= "<strong>@@PRODUCTS@@</strong>: " . __( "return the name of the purchased products separated by a comma", CLICKWHALE_PRO_NAME ) . "<br>";
		$text .= "<strong>@@AMOUNT@@</strong>: " . __( "return the amount of the cart payment", CLICKWHALE_PRO_NAME ) . " (<strong>" . __( "tax and shipping excluded", CLICKWHALE_PRO_NAME ) . "</strong>)<br>";
		$text .= "<strong>@@TAX@@</strong>: " . __( "return the amount of the tax in the purchase", CLICKWHALE_PRO_NAME ) . "<br>";
		$text .= "<strong>@@TOTAL@@</strong>: " . __( "return the total amount of the purchase", CLICKWHALE_PRO_NAME ) . " (<strong>" . __( "tax included", CLICKWHALE_PRO_NAME ) . "</strong>)";
		$text .= '</em>';
