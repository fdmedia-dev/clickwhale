...
1. Upload the `clickwhale` directory to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Visit the settings page, which can be found under the menu: ClickWhale

On the settings page, you will find all the instructions and credentials which are necessary to configure the plugin.
...
= Version 2.5.3.5 (20th March 2026) =
* Fix: WordPress Guideline Violations for the PRO version
* Fix: Various minor fixes and stability improvements

= Version 2.5.3.4 (2nd March 2026) =
* Tweak: Freemius SDK moved to vendor/freemius directory

= Version 2.5.3.3 (26th February 2026) =
...
= Version 2.4.2 (8th January 2025) =
* Fix: Fixed vulnerabilities to enhance code security
* Fix: Fixed PHP "Deprecated" warnings in PHP8.2+
...
* Info: Updated Link Page Credits URL
