...
use Clickwhale\Vendor\WhichBrowser\Model\Browser;
use Clickwhale\Vendor\WhichBrowser\Model\Engine;
use Clickwhale\Vendor\WhichBrowser\Model\Os;
use Clickwhale\Vendor\WhichBrowser\Model\Device;

class Main
{
    /**
     * @var \Clickwhale\Vendor\WhichBrowser\Model\Browser  $browser      Information about the browser
     */
    public $browser;

    /**
     * @var \Clickwhale\Vendor\WhichBrowser\Model\Engine   $engine       Information about the rendering engine
     */
    public $engine;

    /**
     * @var \Clickwhale\Vendor\WhichBrowser\Model\Os       $os           Information about the operating system
     */
    public $os;

    /**
     * @var \Clickwhale\Vendor\WhichBrowser\Model\Device   $device       Information about the device
     */
    public $device;
