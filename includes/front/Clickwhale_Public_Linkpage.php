...
class Clickwhale_Public_Linkpage {
	...
	public function get_copyright() {
		...
		$copyright_link = 'https://clickwhale.pro/linkpages/?utm_source=user+site&utm_medium=linkpage&utm_campaign=ClickWhale+-+Free+Version&utm_content=' . get_bloginfo( 'url' );
