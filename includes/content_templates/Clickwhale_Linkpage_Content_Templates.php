...
class Clickwhale_Linkpage_Content_Templates {
    ...
    public function get_public_link_template( array $data, array $args ): string {
        ...
        $target = '';
        if ( ! empty( $args['target'] ) && in_array( $args['target'], array( '_blank', '_self' ), true ) ) {
            $target = 'target="' . $args['target'] . '"';
        }

        ob_start();
        ?>
        <div class="cw-linkpage-public-row cw-linkpage-public-row--<?php echo esc_attr( $type ); ?>" data-type="<?php echo esc_attr( $type ); ?>">
                ...
                <div class="cw-linkpage-row--image-select--tab">
                    <div class="cw-linkpage-row--image-select--tab-inner tab-multiple">
                        ...
                        <div class="cw-linkpage-row--image-select--item item--icon">
                            <div class="image-item <?php echo esc_attr( $icon_class ); ?>">
                                <input type="radio"
                                       data-type="icon"
                                       id="image-<?php echo esc_attr( $id ); ?>-icon"
                                       name="links[<?php echo esc_attr( $id ); ?>][image][image_id]"
                                       value="<?php echo $image_id && $image_type == 'icon' ? esc_attr( $image_id ) : ''; ?>"
                                    <?php if ( $image_id && $image_type == 'icon' ) { ?>
                                        checked
                                    <?php } ?>
                                >
                                <label for="image-<?php echo esc_attr( $id ); ?>-icon">
                                    <?php if ( $image_id && $image_type == 'icon' ) { ?>
                                        <ion-icon name="<?php echo esc_attr( $image_id ); ?>"></ion-icon>
                                    <?php } ?>
                                </label>
                            </div>
                            <a id="icon-picker-<?php echo esc_attr( $id ); ?>"
                               class="icon-picker" href="#"
                            ><?php esc_html_e( 'Select Icon', 'clickwhale' ); ?></a>
                        </div>

                        <div class="cw-linkpage-row--image-select--item item--emoji">
                            <div class="image-item <?php echo esc_attr( $emoji_class ); ?>">
                                <input type="radio"
                                       data-type="emoji"
                                       id="image-<?php echo esc_attr( $id ); ?>-emoji"
                                       name="links[<?php echo esc_attr( $id ); ?>][image][image_id]"
                                       value="<?php echo $image_id && $image_type == 'emoji' ? esc_attr( $image_id ) : ''; ?>"
                                    <?php if ( $image_id && $image_type == 'emoji' ) { echo 'checked'; } ?>
                                />
                                <label for="image-<?php echo esc_attr( $id ); ?>-emoji">
                                    <?php echo $image_id && $image_type == 'emoji' ? esc_html( $image_id ) : ''; ?>
                                </label>
                            </div>
